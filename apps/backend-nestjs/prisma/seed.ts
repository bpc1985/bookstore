...
async function main() {
  ...
  // Create books with category associations
  for (const bookData of BOOKS) {
    ...
    const book = await prisma.book.create({
      data: {
        ...
        stock_quantity: bookFields.stock_quantity,
        cover_image: bookFields.cover_image,
      },
    });
  ...
  console.log(`Created ${BOOKS.length} books with category associations.`);
